# Migrating web UI to IntelliRide Companion Design System

Read `artifacts/intelliride-design-system/docs/AGENTS.md` and
`artifacts/intelliride-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/intelliride-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/intelliride-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/intelliride-design-system/hooks/use-toast`
