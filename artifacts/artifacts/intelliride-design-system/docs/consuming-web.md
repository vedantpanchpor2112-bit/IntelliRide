# Consuming IntelliRide Companion Design System in web apps

Read `artifacts/intelliride-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/intelliride-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/intelliride-design-system/styles.css";
```
...
`node_modules/@workspace/intelliride-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/intelliride-design-system/components/ui/button";
import { cn } from "@workspace/intelliride-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/intelliride-design-system/hooks/use-toast";
```
...
`@workspace/intelliride-design-system/components/ui/button`. Run the app's typecheck
