# Migrating Expo UI to IntelliRide Companion Design System

Read `artifacts/intelliride-design-system/docs/AGENTS.md` and
`artifacts/intelliride-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/intelliride-design-system/lib/native-theme` and
  `@workspace/intelliride-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/intelliride-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/intelliride-design-system` and retains only
