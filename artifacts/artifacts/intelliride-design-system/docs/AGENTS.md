# IntelliRide Companion Design System design system
...
workspace package (`@workspace/intelliride-design-system`): other artifacts depend
...
`@workspace/intelliride-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/intelliride-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/intelliride-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/intelliride-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/intelliride-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/intelliride-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/intelliride-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/intelliride-design-system/docs/migrating-expo.md`
