# Consuming IntelliRide Companion Design System in Expo apps

Read `artifacts/intelliride-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/intelliride-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/intelliride-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/intelliride-design-system/lib/native-theme";
import { useColors } from "@workspace/intelliride-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/intelliride-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/intelliride-design-system/components/native/badge";
import { Button } from "@workspace/intelliride-design-system/components/native/button";
import { Card } from "@workspace/intelliride-design-system/components/native/card";
```
...
Import and render
`@workspace/intelliride-design-system/components/native/button`, then run Expo
